...
for elt in defaultDiacriticsRemovalap
  letters = elt.letters.split("")
  for letter in letters
    diacriticsMap[letter] = elt.base


angular.module('activeStoryApp')
.factory 'markdown', ($window) ->
  removeDiacritics = (str) ->
    return str.replace /[^\u0000-\u007E]/g, (a) ->
      return diacriticsMap[a] || a

  rend = new $window.marked.Renderer();
  old_rend = new $window.marked.Renderer();
